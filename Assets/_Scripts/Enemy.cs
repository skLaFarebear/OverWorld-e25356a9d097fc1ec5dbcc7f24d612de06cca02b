...
public class Enemy : MonoBehaviour {
	...
	public float		fireRate = 0.3f; 		// Sceonds/shot (Unused)
	...
	public Vector3		boundsCenterOffset;		// Dist of bounds.center from prosition 
...
void OnCollisionEnter( Collision coll ) {
	...
	case "ProjectileHero":
		...
		//Hurt this Enermy
		ShowDamage();
		//Get the demage amount from the Projectile.type & Main.W_DEFS
