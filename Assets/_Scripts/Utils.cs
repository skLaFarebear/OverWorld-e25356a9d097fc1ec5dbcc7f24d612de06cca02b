...
public enum BoundsTest {
	center, 	// Is the center of the GameObject onscreeen?
...
public class Utils : MonoBehaviour {
	...
	public static Bounds BoundsUnion( Bounds b0, Bounds b1 ) {
		...
		// Strectch b0 to include the b1.min and b1.max
	...
	// until it either finds a parent with a tag != "Utagge" or no parent
	public static GameObject FindTaggedParent( GameObject go) {
		// If this gameObject has a tag
		if (go.tag != "Untagged") {
			// then eturtn this gameObject
			return(go);
		}
		...
		// Otherwise, recrusively climb up the tree
	...
	public static Bounds CombineBoundsOfChildren(GameObject go) {
		...
		if (go.renderer != null) {
			// Expands b to contain the Renderer's Bounds
	...
	static public Bounds camBounds {
		get {
			// if _camBounds hasen't been set yet
	...
	public static void SetCameraBounds(Camera cam=null) {
		...
		// This makes a caouple of important assumptions about the camera!:
	...
	public static Vector3 BoundsInBoundsCheck( Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen ) {
		...
		case BoundsTest.center:
			...
			// The onScreen test dtermines what off would have to be applied to
	...
	// Returns a list of all Materials on this GameOject or it's children
