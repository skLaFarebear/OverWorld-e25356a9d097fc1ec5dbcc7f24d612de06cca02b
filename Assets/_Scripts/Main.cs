...
public class Main : MonoBehaviour {
	...
	static public WeaponDefinition GetWeaponDefinition( WeaponType wt ) {
		...
		// Attempting to retrieve a key that didn't exists, would throw an error,
	...
	public void Restart() {
		// Reload _Scene_0 to restart the gane
	...
	public void ShipDestroyed( Enemy e ) {
		...
		if (Random.value <= e.powerUpDropChance) {
			...
			//Pick one from the possiblities in powerUpFrequency
